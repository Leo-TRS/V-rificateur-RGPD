...
Utilisation - Lancez python rgpd_verif.py puis collez le chemin de votre fichier PDF dans le terminal. 2 contrats exemples sont a dispositions pour tester le verificateur, l'un avec la totalité des clauses, l'autre avec des clauses manquantes. 
